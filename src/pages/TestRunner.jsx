...
const TestRunner = ({ test, onClose }) => {
    ...
    if (isFinished) {
        return (
            <div className="fixed inset-0 z-modal-top flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                <div className="bg-surface rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl animate-fade-in">
    ...
    return (
        <div className="fixed inset-0 z-modal-top flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-surface rounded-3xl w-full max-w-3xl overflow-hidden shadow-2xl flex flex-col h-[600px] animate-fade-in relative">
